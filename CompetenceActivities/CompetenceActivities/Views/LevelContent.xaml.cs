...
namespace MentoringFramework.Views
{
    /**
	 * LevelContent
	 * nodes of a route
    ...
    public partial class LevelContent : ContentView, Node
    {
        ...
        public LevelContent(string description, string imgloc = null) : base()
        {
            ...
            section_layout.BackgroundColor = Route.PrimaryColor;
            setCompletion(false);
        ...
        public void setCompletionColors()
        {
            ...
            section_name.TextColor = Route.PrimaryColor;
        }
    ...
    public class ResourcePDF : LevelContent
    {
        Uri pdfloc;        
        public ResourcePDF(String header, Uri path = null) : base(header)
        {
            pdfloc = path;
        }
        ...
        {
            if(pdfloc != null) Device.OpenUri(pdfloc);
            setCompletion(true);
            setCompletionColors();
        }
    ...
    public class Sublevel : LevelContent
    {
        ...
        {
            _level = page;
            setAccessibility(_level.isAccessible());
        }
